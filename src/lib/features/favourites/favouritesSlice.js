...
export const addFavourite = createAsyncThunk(
  ...
  async (countryData, { getState, rejectWithValue }) => {
    try {
      const state = getState();
      const countryName = countryData.name.common;

      if (state.favourites.favourites.some(f => f.country_name === countryName)) {
        return rejectWithValue("Country is already in favourites");
      }
